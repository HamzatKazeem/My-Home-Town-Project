...
// A Javascript function being to perform image slider.
...
document.getElementById('prvBtn').addEventListener('click', (event) => {
  ImageGallery.unshift(ImageGallery.slice(-1)[0]);
  ImageGallery.pop();
  load_gallery();
